...
**Computational audit repository, A39–A71**  
...
- **33 main audits:** A39 through A71.
...
- **English figures:** 58 regenerated publication figures.
...
├── AUDIT_INDEX.md          # One-row index for A39–A71
...
The generator reads the committed JSON results and overwrites the 58 PNG files in `figures/`.
...
Several audits are computationally expensive, especially A62, A67, A70, and A71. See `RUNBOOK.md` before starting a full replay.
